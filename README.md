...
All-The-Mods-Translated-BR-SE-Pack

## instruções

Depois de baixar o arquivo renomeie ele para
```All-The-Mods-Translated-BR-SE-Pack_0.0.1.zip```
para que possa ser executado.

Coloque ele na pasta dos mods e abra seu jogo.

caso ele ja tenha a extensão ```.zip``` apenas renomeie para ```All-The-Mods-Translated-BR-SE-Pack_0.0.1```
